  ...
  return (
    <div className="mx-auto max-w-4xl space-y-6">
      ...
      <div className="grid grid-cols-2 gap-3 sm:gap-4 md:grid-cols-3">
        <div className="col-span-2 rounded-2xl border border-border bg-panel p-4 shadow-card sm:col-span-1 sm:p-5">
        ...
        <div className="rounded-2xl border border-border bg-panel p-4 shadow-card sm:p-5">
